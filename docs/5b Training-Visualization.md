...
For interactive model inference with a GUI, see [Digit Recognizer GUI](#4.1). For details on how training logs are generated during model training, see [Training Pipeline](#5.2).
...
**Sources**: [README.md L29-L31](https://github.com/ThalesMMS/Rust-Neural-Networks/blob/0e978f90/README.md#L29-L31)

 [README.md L142-L148](https://github.com/ThalesMMS/Rust-Neural-Networks/blob/0e978f90/README.md#L142-L148)
...
* [Training Visualization](#4.2-training-visualization)
* [Purpose and Functionality](#4.2-purpose-and-functionality)
* [Data Flow Architecture](#4.2-data-flow-architecture)
* [End-to-End Pipeline](#4.2-end-to-end-pipeline)
* [Log File Format](#4.2-log-file-format)
* [CSV Structure](#4.2-csv-structure)
* [Configuration and File Selection](#4.2-configuration-and-file-selection)
* [Configuration Constants](#4.2-configuration-constants)
* [Function Reference](#4.2-function-reference)
* [Function Mapping to Code](#4.2-function-mapping-to-code)
* [load_training_data(filepath, max_epochs=10)](#4.2-object-object)
* [main()](#4.2-object-object-1)
* [Visualization Components](#4.2-visualization-components)
* [Subplot Layout](#4.2-subplot-layout)
...
* [Output Files and Terminal Output](#4.2-output-files-and-terminal-output)
* [Generated Files](#4.2-generated-files)
* [Terminal Output](#4.2-terminal-output)
* [Usage Instructions](#4.2-usage-instructions)
* [Basic Execution](#4.2-basic-execution)
* [Installation of Dependencies](#4.2-installation-of-dependencies)
* [Visualizing Different Models](#4.2-visualizing-different-models)
* [Integration with Rust Training Pipeline](#4.2-integration-with-rust-training-pipeline)
* [Log File Generation Flow](#4.2-log-file-generation-flow)
